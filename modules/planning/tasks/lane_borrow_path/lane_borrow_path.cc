...
bool LaneBorrowPath::GetBoundaryFromNeighborLane(
    ...
    for (size_t i = 0; i < path_bound->size(); ++i) {
        ...
        // double a_x = 0.0;
        // double a_y = 0.0;
        // double v_x = reference_line_info_->vehicle_state().x();
        // double v_y = reference_line_info_->vehicle_state().y();
        // //
        // if (!flag_1 && obstacles.Items().size() > 12) {
        //     for (const auto& obstacle : obstacles.Items()) {
        //         double o_x = obstacle->PerceptionBoundingBox().center().x();
        //         double o_y = obstacle->PerceptionBoundingBox().center().y();

        //         a_x = a_x + o_x;
        //         a_y = a_y + o_y;
        //     }
        //     a_x = (a_x / obstacles.Items().size()) - v_x;
        //     a_y = (a_y / obstacles.Items().size()) - v_y;
        //     flag_1 = true;
        // }
        if (obstacles.Items().size() > 12) {
            curr_left_bound = curr_left_bound_lane + 6.8 - offset_to_map;
            curr_right_bound = curr_right_bound_lane - offset_to_map;
        } else {
            curr_left_bound = curr_left_bound_lane + 1.5 - offset_to_map;
            curr_right_bound = curr_right_bound_lane - offset_to_map;
        }
        // AINFO << "AY" << a_y;
        // if (obstacles.Items().size() < 12) {
        ...
        //     curr_left_bound = curr_left_bound_lane + 1.5 - offset_to_map;
        //     curr_right_bound = curr_right_bound_lane - offset_to_map;
        // } else if (obstacles.Items().size() >= 12 && a_y > 0) {
        //     AINFO << "进入左扩展";
        ...
        //     curr_right_bound = curr_right_bound_lane - 6.8 - offset_to_map;
        // } else {
        //     curr_left_bound = curr_left_bound_lane + 1.5 - offset_to_map;
        //     curr_right_bound = curr_right_bound_lane - offset_to_map;
        // }
