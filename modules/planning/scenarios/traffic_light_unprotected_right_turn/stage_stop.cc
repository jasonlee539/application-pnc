...
StageResult TrafficLightUnprotectedRightTurnStageStop::Process(
    ...
    for (const auto& traffic_light_overlap_id : context->current_traffic_light_overlap_ids) {
        ...
        if (signal_color != TrafficLight::GREEN) {
            ...
            traffic_light_no_right_turn_on_red = CheckTrafficLightNoRightTurnOnRed(traffic_light_overlap_id);
            break;
        }
    }
...
bool TrafficLightUnprotectedRightTurnStageStop::CheckTrafficLightNoRightTurnOnRed(const std::string& traffic_light_id) {
...
StageResult TrafficLightUnprotectedRightTurnStageStop::FinishStage(const bool protected_mode) {
    auto context = GetContextAs<TrafficLightUnprotectedRightTurnContext>();
    if (protected_mode) {
        // intersection_cruise
